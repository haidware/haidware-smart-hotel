...
from . import views
from . import payment_extensions
app_name='dashboard'
urlpatterns=[
 ...
 path('payments/',payment_extensions.payments,name='payments'),path('workflow/',views.workflow,name='workflow'),
 ...
 path('guest/<str:room_id>/',payment_extensions.guest_device,name='guest_device')]